...
window.addEventListener("keydown", (e) => {
  if (e.key === "5") {
    ...
    btn5.setAttribute(
      "style",
      "background-color:rgb(88, 88, 106);scale:   85%"
    );
    setTimeout(() => {
...
window.addEventListener("keydown", (e) => {
  if (e.key === "c") {
    ...
    clrBtn.setAttribute(
      "style",
      "background-color: rgb(216, 42, 42);scale:85%"
    );
    setTimeout(() => {
